    ...
    <div class="main-banner header-text" id="top">
        <div class="" id ="produk">
          <!-- Form -->
            ...
            <div class = "col-3"></div>
            <div class = "col-6">
            <form action="/dproduk-update" method="post">
            @method('put')
            @csrf
            <h4 style="color:green">Tambah Produk</h4>

            <input type="hidden" name="id" class="form-control" value="{{$dproduk->id}}">
            <label style="color:green" for="">Nama Produk</label>
            <input type="text" name="nama_produk" class="form-control" value="{{$dproduk->nama_produk}}">
            <label style="color:green" for="">Kategori</label>
            <input type="text" name="kategori" class="form-control" value="{{$dproduk->kategori}}">
            <label style="color:green" for="">Harga</label>
            <input type="text" name="harga" class="form-control" value="{{$dproduk->harga}}">
            <br>
