    ...
    <div class="main-banner header-text" id="top">
        <div class="" id ="produk">
          <!-- Form -->
            ...
            <div class = "col-3"></div>
            <div class = "col-6">
            <form action="/grup-update" method="post">
            @method('put')
            @csrf
            <h4 style="color:green">Tambah Grup Pengguna</h4>

            <input type="hidden" name="id" class="form-control" value="{{$grup->id}}">
            <label style="color:green" for="">Nama Pengguna</label>
            <input type="text" name="nama_pengguna" class="form-control" value="{{$grup->nama_pengguna}}">
            <label style="color:green" for="">Status</label>
            <input type="text" name="status" class="form-control" value="{{$grup->status}}">
