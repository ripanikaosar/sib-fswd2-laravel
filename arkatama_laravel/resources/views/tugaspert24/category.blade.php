            ...
            <div class="img-fill">
                <div class="text-content">
                    <table class="table table-striped " style="color:white">
                      ...
                      <h4 class="text-center m-4">Kategori</h4>
                      <a class = "btn btn-primary m-1" href="/category-create">Tambah Data</a>
                          <thead>
                              <tr>
                              <th scope="col">No</th>
                          ...
                          <tbody>
                              ...
                              <td>{{$k->kode}}</td>
                              <td>
                                <a href="/category-edit/{{$k->id}}" class="btn btn-warning">Edit</a>
                                <a href="/category-delete/{{$k->id}}" class="btn btn-danger">Delete</a>
                              </td>
