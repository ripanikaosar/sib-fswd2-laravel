            ...
            <div class="img-fill">
                <div class="text-content">
                    <table class="table table-striped " style="color:white">
                      ...
                      <a class = "btn btn-primary m-1" href="/grup-create">Tambah Data</a>
                          <thead>
                              <tr>
                              <th scope="col">No</th>
                          ...
                          <tbody>
                              ...
                              <td>{{$g->nama_pengguna}}</td>
                              <td>{{$g->status}}</td>
                              
                              <td>
                                <a href="/grup-edit/{{$g->id}}" class="btn btn-warning">Edit</a>
                                <a href="/grup-delete/{{$g->id}}" class="btn btn-danger">Delete</a>
                              </td>
