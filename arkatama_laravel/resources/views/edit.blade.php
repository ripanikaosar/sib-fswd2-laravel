...
<body>
        ...
        <form action="edit_pengguna_func.php" method="post" enctype="multipart/form-data">
            ...
            <input style="width: 100%" type="text" id="name" name = "name" value="<?php echo 'Tantan'?>" placeholder="Nama Lengkap" required>
            <br>
            <br>
            </div>
            ...
            <input style="width: 90%" type="email" id="email" name = "email" value="<?php echo 'tantan27enamdua@gmail.com'?>" placeholder="name@example.com" required>
            <br>
            <br>
            </div>
            ...
            <input style="width: 100%" type="text" id="phone" name = "phone" value="<?php echo '0986666666'?>" placeholder="08967565" required>
            <br>
            <br>
            </div>
            </div>
            ...
            <input style="width: 100%;"   type="text" id="address" name = "address" value="<?php echo 'Jalan Karasak'?>" placeholder="Masukkan Alamat Lengkap" required>
            <br>
            <br>
            </div>
