...
-->
  ...
  <body class="bg-dark">
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            ...
            <li class="nav-item active">
              ...
              <li class="nav-item">
                <a role = "button" class="nav-link text-dark" style="background-color: greenyellow; border-radius:1em" href="{{url('\login')}}">Login</a>
              </li>
    ...
    <div class="container p-5 bg-dark">
                      ...
                      <h4 class="text-center text-light m-4 p-4">Login</h4>
                      
                            
                      <form class= "mx-auto text-light col-5" action ="{{ url('/login') }}" method="post">
                        @csrf
                        <div class="mb-3">
                        ...
                        <a href="{{ url('/register') }}" class="btn text-link flex-end text-light">Register</a>
